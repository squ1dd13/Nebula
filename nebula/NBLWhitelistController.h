...
@interface NSEntityDescription : NSObject {}
  +(id)insertNewObjectForEntityForName:(id)name inManagedObjectContext:(id)object;
@end

@interface NBLWhitelistController : PSListController

@end

@interface WhitelistTableViewCell : UITableViewCell <UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate>
{
    UITableView* whitelistTable;
